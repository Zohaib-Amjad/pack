...
export default function CustomHeader() {
  return (
    <header className="border-b border-[#d9ddd9] bg-white sticky top-0 z-50">
      {/* Top Banner Bar */}
      ...
      <div className="mx-auto flex h-[66px] w-full max-w-[1280px] items-center justify-between px-[16px] sm:px-[32px]">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <Link
            href="/custom-quote"
            className="inline-flex h-10 items-center justify-center rounded-[8px] bg-[#ee7a1b] px-4 text-[12px] font-semibold leading-none text-white transition-colors hover:bg-[#d46710] sm:px-5"
          >
            Get a Quote
          </Link>
        </div>
