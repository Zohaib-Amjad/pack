...
export default function AdminBlogNewView() {
  ...
  const handleSave = async (publishNow = false) => {
    ...
    setSaving(true);
    const postSlug = slug.trim() || title.toLowerCase().replace(/\s+/g, "-");

    // Simulate saving / publishing
    setTimeout(() => {
      setSaving(false);
      toast({
        title: publishNow || isPublished ? "Post Published!" : "Draft Saved",
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      toast({
        ...
        description: `${file.name} ready for article cover.`,
      });
    }
  };
            ...
            <div className="grid xl:grid-cols-[1fr_360px] gap-5 items-start">
                ...
                <div className="bg-white border border-[#e0ddd6] rounded-[12px] p-6">
                  ...
                  <div className="mb-5 p-4 rounded-[10px] bg-[#f5f3ee] border border-[#e0ddd6]">
                    ...
                    <p className="text-[#006621] text-[11px] mt-0.5">
                      hofpack.com › blog › {slug || "post-slug"}
                    </p>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="bg-white border border-[#e0ddd6] rounded-[12px] p-5">
                  ...
                  <div className="mt-4">
                    <div className="flex items-center justify-between mb-1.5">
                      <span className="text-[10px] text-[#aaa6a0] font-medium">
                        Completeness
                      </span>
                    ...
                    <div className="h-1.5 bg-[#f5f3ee] rounded-full overflow-hidden">
                      <div
                        className="h-full bg-[#2d5c3e] rounded-full transition-all duration-500"
